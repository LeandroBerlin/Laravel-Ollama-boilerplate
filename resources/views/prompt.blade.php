        ...
        <div class="relative sm:flex sm:justify-center sm:items-center min-h-screen min-w-min bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
            ...
            <div class="w-1/2 mx-auto p-6 lg:p-8">
                <div class="flex justify-center">
                    <a href="/">
                    <svg viewBox="0 0 62 65" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-16 w-auto bg-gray-100 dark:bg-gray-900 animate-pulse">
                    ...
                    <a href="/">
                    <img src={{ URL::to('/') }}/ollama.png class="ml-3 h-16 animate-pulse" />
                    </a>
                </div>
                ...
                <div class="mt-16">
                        ...
                        <div>
                            <div>
                                ...
                                <div id="spinner" role="status" class="mb-8 {{isset($response) ? "hidden" : "block"}}">
